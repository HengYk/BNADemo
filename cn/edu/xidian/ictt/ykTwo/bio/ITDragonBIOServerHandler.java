package cn.edu.xidian.ictt.ykTwo.bio;

import cn.edu.xidian.ictt.ykTwo.util.CalculatorUtil;
    ...
    public void run() {
        ...
        try {
            ...
            while (true) {
                ...
                writer.println(body + " = " + Objects.requireNonNull(CalculatorUtil.cal(body)).toString());
            }
        } catch (IOException e) {
            e.printStackTrace();
        } finally {
